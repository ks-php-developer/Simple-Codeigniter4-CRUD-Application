		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<div class="card-body">
						<form name="createForm" id="createForm" method="POST" action="<?php echo base_url('/books/create'); ?>">
							<div class="form-group">
								<label>Name</label>
								<input type="text" placeholder="Name" name="name" id="name" class="form-control <?php echo (isset($validation) && $validation->hasError('name')) ? 'is-invalid' : ''; ?>" value="" />
							...
							<div class="form-group">
								<label>Author</label>
								<input type="text" placeholder="Author" name="author" id="author" class="form-control <?php echo (isset($validation) && $validation->hasError('author')) ? 'is-invalid' : ''; ?>" value="" />
							...
							<div class="form-group">
								<label>ISBN No</label>
								<input type="text" placeholder="ISBN No" name="isbn_no" id="isbn_no" class="form-control" value="" />
							</div>
